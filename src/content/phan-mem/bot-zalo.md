...
ghiChuCapNhat: "- Bản Windows nay chỉ còn MỘT file .exe — tải về bấm chạy, không phải giải nén\n- Quét mã QR chuyển khoản là phần mềm tự cộng ngày, không phải nhắn ai\n- Bản 1.4 làm mất bản quyền khi cập nhật, đã sửa từ 1.5"
...
linkTaiWin: "https://github.com/doanngoclam3000-creator/doanngoclam3000-creator.github.io/releases/download/bot-zalo-1.6/BotZalo-1.6-Windows.exe"
gia: "150.000đ / tháng — dùng thử miễn phí 10 ngày"
dungLuong: "75 MB (Windows, một file chạy luôn)"
